...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value = ''
        Entry(width = 36,font = ('Crash Numbering Font', 16), textvariable = self.equation).place(x=0,y=0)
        ...
        Button(width=8, text = "=", relief ='flat', command=self.solve).place(x=180, y=210)
        Button(width=8, text = "C", relief ='flat', command=self.clear).place(x=270,y=50)
